...
COMP=$(GCC) -o $(MAIN_OUTPUT) -g $(MAIN_INPUT) $(MYSQL_LIBS) -lpthread -lrrd -L/usr/local/include -L/usr/include -L/usr/local/lib -L/usr/lib -L/opt/local/include -L/opt/include
